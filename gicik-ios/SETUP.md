...
Bu `project.yml`'den `Gicik.xcodeproj` üretir. SPM dependencies otomatik tanımlı:
- supabase-swift
- RevenueCat
- PostHog
- Sentry
...
2. Bundle ID: `to.tikla.gicik`
3. `gicik-ios/Gicik/` altındaki tüm `.swift` dosyalarını sürükleyip bırak
